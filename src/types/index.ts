...
export interface Company {
  ...
  /** Persistent compute grid (0..100); increases renewable generation and has recurring upkeep. */
  computeInfrastructure: number;
  /** Compute added to the unallocated pool by departments during the last resolved turn. */
  lastComputeGenerated: number;
...
export interface Product {
  ...
  computePoints: number;
  /** Last revenue multiplier created by assigned compute and a lead over direct rivals. */
  lastComputeMultiplier: number;
  /** Additional revenue bonus from leading direct rivals on compute, 0..0.2. */
  computeAdvantage: number;
